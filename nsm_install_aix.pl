...
foreach my $remote_host (@hosts) {
	...
	my $root_cmd1 = "awservices stop; unishutdown all; cp -p /etc/sysctl.conf /etc/sysctl.conf.b4NSM; cp -p /etc/profile /etc/profile.b4NSM; mount -o ro tunim01:/opt/install /mnt; cd /mnt/src/nsm31_aix; ./setupNSM";
