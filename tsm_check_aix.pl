...
foreach my $remote_host (@hosts) {
	...
	my $root_cmd1 = "lslpp -l tivoli.tsm.client\*";
	my $root_cmd2 = "ls -l /usr/tivoli/tsm/client/ba/bin/dsm.sys /usr/tivoli/tsm/client/ba/bin/dsm.opt /usr/tivoli/tsm/client/ba/bin/inclexcl.txt";
	my $root_cmd3 = "ls -ld /usr/tivoli/tsm/logs; ls -l /usr/tivoli/tsm/logs/ /usr/local/bin/tsm_sched_restart.ksh; egrep 'dsm|tsm' /etc/rc.local";
